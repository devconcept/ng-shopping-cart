...
describe('CartViewComponent', () => {
  ...
  describe('Component with items', () => {
    ...
    it('should display items when added to the items input', async(() => {
      fixture.detectChanges();
      const emptyPanel = fixture.debugElement.query(By.css('.cart-view-empty'));
    ...
    it('should display header texts when there are items in the cart', async(() => {
      fixture.detectChanges();
      const cartListHeaders = fixture.debugElement.query(By.css('.cart-list-header'));
    ...
    it('should allow to change header texts', async(() => {
    ...
    it('should display footer texts when there are items in the cart', async(() => {
    ...
    it('should allow to change footer texts', async(() => {
